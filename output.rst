...
.. code:: sh
  ...
  myArray.cpp: In function ‘int main()’:
  myArray.cpp:113:42: error: no matching function for call to ‘operator<<(std::basic_ostream<char>&, <unresolved overloaded function type>)’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  ...
  myArray.cpp:113:42: note:   couldn’t deduce template parameter ‘_Alloc’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  ...
  myArray.cpp:113:42: note:   cannot convert ‘std::endl’ (type ‘<unresolved overloaded function type>’) to type ‘const std::error_code&’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  ...
  myArray.cpp:113:42: note:   cannot convert ‘std::endl’ (type ‘<unresolved overloaded function type>’) to type ‘char’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  In file included from /usr/include/c++/9/iostream:39,
                   from myArray.cpp:1:
  ...
  myArray.cpp:113:42: note:   cannot convert ‘std::endl’ (type ‘<unresolved overloaded function type>’) to type ‘signed char’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  In file included from /usr/include/c++/9/iostream:39,
                   from myArray.cpp:1:
  ...
  myArray.cpp:113:42: note:   cannot convert ‘std::endl’ (type ‘<unresolved overloaded function type>’) to type ‘unsigned char’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  In file included from /usr/include/c++/9/iostream:39,
                   from myArray.cpp:1:
  ...
  myArray.cpp:113:42: note:   cannot convert ‘std::endl’ (type ‘<unresolved overloaded function type>’) to type ‘const char*’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  In file included from /usr/include/c++/9/iostream:39,
                   from myArray.cpp:1:
  ...
  myArray.cpp:113:42: note:   cannot convert ‘std::endl’ (type ‘<unresolved overloaded function type>’) to type ‘const signed char*’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  In file included from /usr/include/c++/9/iostream:39,
                   from myArray.cpp:1:
  ...
  myArray.cpp:113:42: note:   cannot convert ‘std::endl’ (type ‘<unresolved overloaded function type>’) to type ‘const unsigned char*’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  In file included from /usr/include/c++/9/iostream:39,
                   from myArray.cpp:1:
  ...
  myArray.cpp:113:42: note:   couldn’t deduce template parameter ‘_Tp’
    113 |   operator<<(operator<<(cout, "2 "), endl);
        |                                          ^
  cpp991$ 
